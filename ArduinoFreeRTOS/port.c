...
/* Disable this part for Atmel AVR ATmega323
	...
	*pxTopOfStack = ( portSTACK_TYPE ) ( usAddress & ( unsigned short ) 0x00ff ); */
    ...
    /* ATmega2560 has a 22 bit program memory address space
     * Push 3 bytes onto the stack for a correct return address */
    unsigned portLONG ulAddress;
    ulAddress = ( unsigned portLONG ) pxCode;
	*pxTopOfStack = ( portSTACK_TYPE ) ( ulAddress & ( unsigned portLONG ) 0x000000ff );
	pxTopOfStack--;
    ulAddress >>= 8;
	*pxTopOfStack = ( portSTACK_TYPE ) ( ulAddress & ( unsigned portLONG ) 0x000000ff );
	pxTopOfStack--;
